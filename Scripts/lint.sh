...
swiftlint --path . --config .swiftlint.yml --quiet --strict | stripPWD | convertToGitHubActionsLoggingCommands
swiftformat . --swiftversion 5 --lint 2> >(stripPWD) | convertToGitHubActionsLoggingCommands
