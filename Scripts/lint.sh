...
set -o pipefail && swiftlint --path . --config .swiftlint.yml --quiet --strict | stripPWD | convertToGitHubActionsLoggingCommands
set -o pipefail && swiftformat . --swiftversion 5 --lint 2> >(stripPWD) | convertToError | convertToGitHubActionsLoggingCommands